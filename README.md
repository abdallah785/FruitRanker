                  ...
                  - - Stripe pour les paiements Premium
                    ...
                    - ```javascript
                      const CONFIG = {
                        ...
                        ANTHROPIC_API_KEY: 'sk-ant-apiXX-XXX...',
                        STRIPE_PAYMENT_LINK: 'https://buy.stripe.com/XXX',
                        PREMIUM_PRICE: '4,99 EUR/mois'
                      };
                      ```
                      ...
                      - - **Votes** : user_id, fruit, score, date
                        - - **Tournaments** : user_id, gagnant, date
                          - - **Payments** : user_id, stripe_id, date, statut
                            ...
                            - Le site est pret pour GitHub Pages. Pousse sur `main` et active Pages dans Settings > Pages > main / root.
